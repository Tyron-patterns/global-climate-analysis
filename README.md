...
02_data_cleaning.sql # Handle missing values and duplicates 
03_global_analysis.sql # Temperature trends and regression analysis 
04_outlier_analysis.sql # Z-score outlier detection and stddev comparison
